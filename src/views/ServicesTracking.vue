<template>
  <ion-page>
    ...
    <Layout
      btnSrc="/tabs/servicesTrackingTerms"
      height="false"
      filledBtn="Далее"
      outlineBtn="."
        ...
        <LayoutBox>
          <template v-slot:content>
            <ion-text>
              ...
              <p class="sub-title">
                Просим предоставить информацию о ходе выполнения мероприятий по
            ...
            <ion-text>
              <p class="sub-title">
                Номер договора о подключении (технологическом присоединении)

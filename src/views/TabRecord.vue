            ...
            <template v-slot:main-content>
                ...
                <ion-list>
                    ...
                    <ion-item router-link="/tabs/time">
                        ...
                        <ion-text class="sub-title">{{ entryTime ? entryTime : "Выберите время записи" }}</ion-text>
        ...
        <Layout v-else outlineBtn="." filledBtn="Вернуться" :method="() => reset()" title="Предварительная запись">
            <template v-slot:main-content>
                ...
                <ion-item>
                    ...
                    <ion-text slot="end" class="text-end text-success">{{entryDate}}</ion-text>
                </ion-item>
                <ion-item>
                    <ion-text> Время приема: </ion-text>
                    <ion-text slot="end" class="text-end text-success">{{entryTime}}</ion-text>
                </ion-item>
            </template>
        </Layout>
    </ion-page>
...
export default defineComponent({
    ...
    methods: {
        ...
        sendPreregRequest() {
            ...
            if (this.entryServiceType !== '' && this.entryServiceType !== 'Неверный код сервиса') {
                status++;
            }
            if (this.entryDate) {
                status++;
